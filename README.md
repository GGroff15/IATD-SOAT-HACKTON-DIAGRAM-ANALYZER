...
- **AWS S3 bucket:** Required for input file access and optional for output storage
...
2. Edit `.env` with the minimum required values:
  - `S3_BUCKET_NAME` (required, no default)
...
2. Run the container (replace placeholders):
  ...
  docker run --rm -p 8000:8000 \
    -e S3_BUCKET_NAME=your-diagram-bucket \
...
- `AWS_ENDPOINT_URL` (default: empty)
- `AWS_ACCESS_KEY_ID` (default: empty)
- `AWS_SECRET_ACCESS_KEY` (default: empty)
...
Connection detection tuning:

- `CONNECTION_LINE_THRESHOLD` (default: `100`)
- `CONNECTION_MIN_LINE_LENGTH` (default: `40`)
- `CONNECTION_MAX_LINE_GAP` (default: `10`)
- `CONNECTION_CANNY_LOW` (default: `50`)
- `CONNECTION_CANNY_HIGH` (default: `150`)
- `CONNECTION_PROXIMITY_THRESHOLD` (default: `30.0`)
- `CONNECTION_BORDER_MARGIN` (default: `4.0`)
- `CONNECTION_MAX_COMPONENT_OVERLAP_RATIO` (default: `0.35`)
- `CONNECTION_ANCHOR_DISTANCE_THRESHOLD` (default: empty)
- `CONNECTION_DEDUP_ENDPOINT_TOLERANCE` (default: `10.0`)
- `CONNECTION_DEDUP_ANGLE_TOLERANCE` (default: `6.0`)
- `CONNECTION_MORPHOLOGY_KERNEL_SIZE` (default: `1`)
- `CONNECTION_MIN_CONFIDENCE` (default: `0.45`)
- `CONNECTION_ARROW_WINDOW_SIZE` (default: `14`)
- `CONNECTION_MAX_CONNECTIONS_PER_COMPONENT_PAIR` (default: `1`)
...
- `S3_BUCKET_NAME` has no default and must be set before startup.
